...
<fieldset>
    <form action="controllers/product.php" id="form" class="form-horizontal" method="POST" enctype="multipart/form-data">
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" class="col-xs-10 col-sm-5" name="name" placeholder="Product name" required value="<?= $vRow_Edit['name'] ?>"/>
            ...
            <div class="col-sm-9">
                <select name="category_id" class="col-xs-10 col-sm-5">
                    <?php while ($row = mysql_fetch_array($vResult_PL)) { ?>
                        <option value="<?= $row['id'] ?>" <?= $row['id'] == $vRow_Edit['category_id'] ? 'selected' : '' ?>><?= $row['name'] ?></option>
                    <?php } ?>
                </select>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input class="col-xs-10 col-sm-5" name="sku" placeholder="SKU" type="text" value="<?= $vRow_Edit['sku'] ?>"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input class="col-xs-10 col-sm-5" name="price" type="number" placeholder="Price" value="<?= $vRow_Edit['price'] ?>"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input class="col-xs-10 col-sm-5" name="os" placeholder="Operating System" type="text" value="<?= $vRow_Edit['os'] ?>"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input class="col-xs-10 col-sm-5" name="screen" placeholder="Screen" type="text" value="<?= $vRow_Edit['screen'] ?>"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input class="col-xs-10 col-sm-5" name="cpu" placeholder="CPU" type="text" value="<?= $vRow_Edit['cpu'] ?>"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input class="col-xs-10 col-sm-5" name="ram" placeholder="RAM" type="text" value="<?= $vRow_Edit['ram'] ?>"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input class="col-xs-10 col-sm-5" name="camera" placeholder="Camera" type="text" value="<?= $vRow_Edit['camera'] ?>"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input class="col-xs-10 col-sm-5" name="pin" placeholder="PIN" type="text" value="<?= $vRow_Edit['pin'] ?>"/>
            </div>
        </div>

        <?php if ($vRow_Edit['image'] <> "") { ?>
            <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right">Hình ảnh</label>
                <div class="col-sm-9">
                    <img class="img img-thumbnail" style="width:400px " src="../<?= $vRow_Edit['image'] ?>"/>
                    <input type="hidden" name="image_old" value="<?= $vRow_Edit['image'] ?>"/>
                </div>
            </div>
        <?php } ?>

        <div class="form-group"><div>
                <label class="col-sm-2 control-label no-padding-right" for="content"><?= $vRow_Edit['image'] <> '' ? 'Cập nhật ảnh mới' : 'Hình ảnh' ?></label>
                <div class="col-sm-3">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <textarea class="col-xs-10 col-sm-5" rows="5" name="description" placeholder="Product description"><?= $vRow_Edit['description'] ?></textarea>
            </div>
        </div>
